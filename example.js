  ...
  post: { // let's first create a post
    ...
    attributes: { // it's got some attributes
      title: { // like a titlte
        ...
        maxLength: 1000, // ...that's limited to 1k characters
        ...
        // NOTE: .read can be set here, but
      },
      content: { // every post also has content, which has basically the same rules
        type: 'string',
        maxLength: 10000, // ...except it's 10k chars long
        notNull: true,
        modify: [
          '$.creator',
          '$~moderators'
      ...
      replies: { // then we have the replies
        ...
        // this list doesn't have a maxLength, since they can be grown infinetly without too much impact (TODO: really good idea?), but technically it can be set
